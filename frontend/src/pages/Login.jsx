            ...
            <style>{`
                * { box-sizing: border-box; }
                ...
                .bb-bar {
                    ...
                    background: linear-gradient(to top, rgba(255,255,255,.22), rgba(255,255,255,.70));
                    transform-origin: bottom;
                    animation: bbBars 2.8s ease-in-out infinite alternate;
                }

                .bb-bar:nth-child(2) { animation-delay: .15s; }
                .bb-bar:nth-child(3) { animation-delay: .3s; }
                .bb-bar:nth-child(4) { animation-delay: .45s; }
                .bb-bar:nth-child(5) { animation-delay: .6s; }
                .bb-bar:nth-child(6) { animation-delay: .75s; }
                .bb-bar:nth-child(7) { animation-delay: .9s; }
                .bb-bar:nth-child(8) { animation-delay: 1.05s; }
                ...
                .bb-submit:hover:not(:disabled)::before {
                    left: 145%;
                }
                ...
                @keyframes bbPulse {
                    0%, 100% { opacity: 1; box-shadow: 0 0 0 4px rgba(34,197,94,.10); }
                    50% { opacity: .45; box-shadow: 0 0 0 7px rgba(34,197,94,.03); }
                }
                ...
                @media (max-width: 520px) {
                    ...
                    .bb-showcase { padding: 30px 24px; min-height: 360px; }
                    .bb-eyebrow { margin-top: 35px; }
                    .bb-hero { font-size: 34px; letter-spacing: -1px; }
                    .bb-preview { margin-top: 24px; }
                    .bb-form-side { padding: 34px 22px 38px; }
                    .bb-title { font-size: 31px; }
                    .bb-options { align-items: flex-start; flex-direction: column; }
                    .bb-secure { align-self: flex-end; }
                }

                @media (prefers-reduced-motion: reduce) {
                    .bb-shell, .bb-form, .bb-preview, .bb-bar, .bb-secure-dot {
                ...
                <section className="bb-shell">
                    <div className="bb-showcase">
                        <div>
                            ...
                            <div className="bb-eyebrow">Your money. One clear view.</div>

                            <h1 className="bb-hero">
                                Make your money <span>clearer.</span>
                            </h1>

                            <p className="bb-copy">
                                Track spending, plan budgets, and grow savings in one place.
                            </p>
                            ...
                            <div className="bb-preview">
                                ...
                                <div className="bb-preview-balance">
                                    <div>
                                        <div style={{ fontSize: "9px", color: "rgba(255,255,255,.55)" }}>
                                            AVAILABLE BALANCE
                                        </div>
                                        <div className="bb-balance-value">₹49,100</div>
                                    </div>
                                    <div className="bb-balance-change">↗ 12.8%</div>
                                </div>

                                <div className="bb-chart">
                                    {[38, 53, 46, 68, 57, 76, 63, 88].map((height, i) => (
                                        <span
                                            key={i}
                                            className="bb-bar"
                                            style={{ height: `${height}%` }}
                                ...
                                <div className="bb-mini-row">
                                    ...
                                    <div className="bb-mini">
                                        <small>Budget</small>
                                        <strong>18% used</strong>
                                    </div>
                                </div>
                            </div>

                            <div className="bb-points">
                                <span className="bb-pill">📊 Track</span>
                                <span className="bb-pill">🎯 Plan</span>
                                <span className="bb-pill">💎 Save</span>
                                <span className="bb-pill">🔔 Stay informed</span>
                            </div>
                        </div>
                    ...
                    <div className="bb-form-side">
                        <form className="bb-form" onSubmit={login}>
                            <div className="bb-form-kicker">
                                <span className="bb-kicker-dot" />
                                Welcome back
                            </div>

                            <h2 className="bb-title">Sign in to BudgetBuddy</h2>

                            <p className="bb-subtitle">
                                Pick up where you left off and keep your financial goals moving.
                            </p>

                            <div className="bb-field">
                                <label className="bb-label" htmlFor="login-username">
                                    Username
                                </label>
                                <input
                                    id="login-username"
                            ...
                            <div className="bb-field">
                                <label className="bb-label" htmlFor="login-password">
                                    Password
                                </label>
                            ...
                            <div className="bb-divider">New to BudgetBuddy?</div>
